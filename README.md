...
When configured, the `audit` command with the `--ai` flag will include Philter policy recommendations generated by AI.
...
**This is the recommended format for golden datasets.**
